...
import { ChatBubbleLeftRightIcon, PaperAirplaneIcon } from "@heroicons/react/16/solid";
  ...
  const handleSend = async () => {
    ...
    setTimeout(() => {
      const assistantMessage: Message = {
        ...
        role: "assistant",
        content: "I'm a demo AI assistant. In a real implementation, I would connect to an LLM API like OpenAI, Anthropic, or a local model to provide intelligent responses.",
        timestamp: new Date(),
      };
